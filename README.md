...
Выходными данными является ```cpp std::shared_ptr<std::vector<float[14]>>```. Каждый компонент ```cpp std::vector:float[14] {X0, Y0, x1, y1, w1, x2, y2, w2, x3, y3, w3, x4, y4, w4}```cpp,
