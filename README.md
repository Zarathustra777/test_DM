...
4. [Описание данных](#Описание_данных)
5.[Подсказка по OpenCV](#Подсказка_по_OpenCV)
6. [Описание алгоритма коррекции битых пикселей](#Описание_алгоритма_коррекции_битых_пикселей)
